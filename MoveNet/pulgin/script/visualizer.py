...
"""Script to run visualize pose estimation on predict data."""
import argparse
import cv2
import logging
import numpy as np
...
from MoveNet.pulgin.script import utils
from MoveNet.pulgin.script.data import BodyPart
from MoveNet.pulgin.script.data import person_from_keypoints_with_scores
from movenet import Movenet
from movenet import Posenet
...
def _visualize_detection_result(input_image, ground_truth):
  ...
  Note: This predict is meant to be run by a human who want to visually verify
...
def _create_ground_truth_csv(input_images, ground_truth_csv_path):
  ...
  # Create ground truth data by feeding the predict images through MoveNet
...
def main():
  ...
  # Visualize detection result of the predict images
